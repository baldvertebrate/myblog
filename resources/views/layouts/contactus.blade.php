        ...
        <main class="flex-shrink-0">
                    ...
                    <div class="row gx-5 align-items-center justify-content-center">
                        <div class="col-lg-8 col-xl-7 col-xxl-6">
                            <div class="my-5 text-center text-xl-start">
                                <h1 class="display-5 fw-bolder text-white mb-2">VMIS</h1>
                                <p class="lead fw-normal text-white-50 mb-4">Vehicle Management Information System</p>
            ...
            <section class="py-5" id="features">
                <div class="container px-5 my-5">
                    <div class="row gx-5">
                        <div class="col-lg-4 mb-5 mb-lg-0"><h1 class="fw-bolder mb-0">Hello, I am Russell <br></h2></div>
                        <div class="col-lg-8">
